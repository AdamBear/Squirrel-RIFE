...
def __getAllQss(fontLight, fontDark, normal, light, deep, disLight, disDark, themeImgDir):
    ...
    qss += f"""
        ...
        """
    custom_label_qss_list = ["EncodeSettingsLabel", "RenderSettingsLabel",
                             "GlobalRifeSettingsLabel", "NvidiaRifeSettingsLabel", "NcnnRifeSettingsLabel",
                             "AdvanceSettingsLabel", "OutputLabel", "InputLabel"]
